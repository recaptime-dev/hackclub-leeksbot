...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern:
        "https://gitlab.com/-/ide/project/recaptime-dev/hackclub-leeksbot/edit/main/-/docs/:path",
    ...
    socialLinks: [
      ...
      {
        icon: "slack",
        link: "https://hackclub.slack.com/archives/C07T2EP4PLZ",
      },
      {
        icon: "github",
        link: "https://github.com/recaptime-dev/hackclub-leeksbot",
      },
      {
        icon: "gitlab",
        link: "https://gitlab.com/recaptime-dev/hackclub-leeksbot",
      },
    ],
